...
<html lang="en">
	...
	<body>
                <header><h1>15 Puzzle: Congratulations!</h1></header>
		<nav>
			<ul>
		...
		<main>
			<?php
				$numMoves = $_SESSION['15Puzzle']->getNumMoves();
				echo("<p>You made ".$numMoves." moves.</p>");
			?>
				...
				<table>	
					<?php
						...
						for($i=0;$i<16;$i++){
							...
							$k++ ?>
							<td>
							<img src= <?php echo "assets/".$array[$i].".jpg" ?> name=i0></td>
